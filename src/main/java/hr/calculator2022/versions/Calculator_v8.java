...
public class Calculator_v8 {
    ...
    public static void main(String[] args) {
        ...
        //new code
        calculatorWindow.
                setIconImage(new ImageIcon(Calculator_v8.class.
        ...
        GeneralKeyBoardActivityListener_v8 gkbal
                = new GeneralKeyBoardActivityListener_v8(calculatorButtons);
        ...
        NormalButtonActionListener_v8 nbal
                = new NormalButtonActionListener_v8(screen);
        ...
        nbal = new NormalButtonActionListener_v8(screen);
        ...
        DelButtonActionListener_v8 dbal
                = new DelButtonActionListener_v8(screen/*
        ...
        //new code
        calculatorButtons.put("backspace", del);
        ...
        ACButtonActionListener_v8 acbal
                = new ACButtonActionListener_v8(screen);
        ...
        //new code
        OperatorButtonActionListener_v8 obal
                = new OperatorButtonActionListener_v8(screen);
        ...
        //new code
        obal = new OperatorButtonActionListener_v8(screen);
        ...
        //new code
        DotButtonActionListener_v8 dobal
                = new DotButtonActionListener_v8(screen);
        ...
        AnsButtonActionListener_v8 abal = new AnsButtonActionListener_v8(screen);
        ...
        EqualsButtonActionListener_v8 eqbal = new EqualsButtonActionListener_v8(screen);
        equal.addActionListener(eqbal);
        base.add(equal, c);
        calculatorButtons.put("=", equal);
        //new code
        calculatorButtons.put("enter", equal);
...
class NormalButtonActionListener_v8 implements ActionListener {

    JLabel screen1;

    NormalButtonActionListener_v8(JLabel screen2) {
        screen1 = screen2;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (Calculator_v8.operand1 == null) {
            ...
            if (Calculator_v8.operator == null) {
                ...
                if (Calculator_v8.operand2 == null) {
                    valueKeyPressed = ((JButton) e.getSource()).getText();
                    number = Double.parseDouble(valueKeyPressed);
                    Calculator_v8.operand2 = number;
                    screen1.setText(screen1.getText().concat(valueKeyPressed));
                } else {
                    valueKeyPressed = ((JButton) e.getSource()).getText();
                    valueKeyPressed = screen1.getText().concat(valueKeyPressed);
                    String slicer = Calculator_v8.operator;
                    if (Calculator_v8.operator.equalsIgnoreCase("/")) {
                        slicer = "\\u00f7";
                    }
                    if (Calculator_v8.operator.equalsIgnoreCase("*")) {
                        slicer = "\\u00d7";
                    ...
                    Calculator_v8.operand2 = number;
                    screen1.setText(valueKeyPressed);
                    System.out.println("operand1 = " + Calculator_v8.operand1);
                    System.out.println("operand2 = " + Calculator_v8.operand2);
                    System.out.println("operator = " + Calculator_v8.operator);
                }
            }
        }
    }
...
class DelButtonActionListener_v8 implements ActionListener {
    //new code
     ...
     * Calculator screen is what is in place of screen2 DelButtonActionListener_v8
     * dbal = new DelButtonActionListener_v8(screen);
     */
    DelButtonActionListener_v8(JLabel screen2, /*new code*/ 
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (Calculator_v8.operand2 != null) {
            ...
            String op2string = Calculator_v8.operand2.toString();
            /*
            ...
            if (op2string.length() > 1) {
                ...
                screen1.setText(Calculator_v8.operand1 + op2disp + 
                        Calculator_v8.operand2);
            } else {
                Calculator_v8.operand2 = null;
                /*
                 * op2disp = format of operator to display for operators whose
                 * display does not rhyme with their use.
                 */
            ...
            if (Calculator_v8.operator != null) {
                Calculator_v8.operator = null;
                screen1.setText(Calculator_v8.operand1.toString());
            } else {
                if (Calculator_v8.operand1 != null) {
                    //op1string = operand1 as string
                    String op1string = Calculator_v8.operand1.toString();
                    /*
                    ...
                    if (op1string.length() > 1) {
                        op1string = op1string.substring(0, 
                                op1string.length() - 1);
                        Calculator_v8.operand1 = Double.parseDouble(op1string);
                        screen1.setText(Calculator_v8.operand1.toString());
                    } else {
                        //trigger AC button click
                        calculatorButtons1.get("ac").doClick();
                        Calculator_v8.operand1 = null;
                        Calculator_v8.operand2 = null;
                        Calculator_v8.operator = null;
                    }
                }
...
class ACButtonActionListener_v8 implements ActionListener {

    JLabel screen1;

    ACButtonActionListener_v8(JLabel screen2) {
        screen1 = screen2;
    }
...
class GeneralKeyBoardActivityListener_v8 implements KeyListener {

    //property that holds all components laid on calculatorWindow
    HashMap<String, JButton> calculatorButtons1;

    //constructor which receives as parameter a mini-database key-value pairs.
    GeneralKeyBoardActivityListener_v8(HashMap<String, JButton> calculatorButtons2) {
        calculatorButtons1 = calculatorButtons2;
    }
    //empty method
    ...
    public void keyTyped(KeyEvent e) {
        //new code
        Character thekey = e.getKeyChar();
        String thekeyStr = thekey.toString().trim();
        if(thekeyStr.isEmpty()){
            thekeyStr = e.toString().split("keyChar=")[1].split(",")[0].toLowerCase();
        }
        System.out.println("the key typed = " + thekeyStr);
        if (calculatorButtons1.containsKey(thekeyStr)) {
            calculatorButtons1.get(thekeyStr).doClick();
        }
    }
}
...
class AnsButtonActionListener_v8 implements ActionListener {
    JLabel screen1;
    AnsButtonActionListener_v8(JLabel screen2) {
        screen1 = screen2;
    }
    @Override
    public void actionPerformed(ActionEvent e) {
        if(Calculator_v8.answer != null){
            Calculator_v8.operand2 = null;
            Calculator_v8.operator = null;
            Calculator_v8.operand1 = Calculator_v8.answer;
            screen1.setText(""+Calculator_v8.operand1);
        }
    }
}

class EqualsButtonActionListener_v8 implements ActionListener {
    JLabel screen1;
    EqualsButtonActionListener_v8(JLabel screen2) {
        screen1 = screen2;
    }
    @Override
    public void actionPerformed(ActionEvent e) {
        //new code
        if(Calculator_v8.operand1!=null&&
                Calculator_v8.operator!=null&&Calculator_v8.operand2!=null){
            if(Calculator_v8.operator.equalsIgnoreCase("^")){
                Calculator_v8.answer=Math.
                        pow(Calculator_v8.operand1,Calculator_v8.operand2);
            }
            if(Calculator_v8.operator.equalsIgnoreCase("+")){
                Calculator_v8.answer=Calculator_v8.operand1+Calculator_v8.operand2;
            }
            if(Calculator_v8.operator.equalsIgnoreCase("-")){
                NumberFormat nf = NumberFormat.getNumberInstance();
                Calculator_v8.answer= Double.parseDouble(nf.
                        format(Calculator_v8.operand1-Calculator_v8.operand2));
            }
            if(Calculator_v8.operator.equalsIgnoreCase("*")){
                Calculator_v8.answer=Calculator_v8.operand1*Calculator_v8.operand2;
            }
            if(Calculator_v8.operator.equalsIgnoreCase("/")){
                if(Calculator_v8.operand2!=0){
                    Calculator_v8.answer=Calculator_v8.operand1/Calculator_v8.operand2;
                }else{
                    Calculator_v8.answer = 0.0;
                }
            }
            Calculator_v8.operand2 = null;
            Calculator_v8.operator = null;
...
//new code
class OperatorButtonActionListener_v8 implements ActionListener {
    JLabel screen1;
    OperatorButtonActionListener_v8(JLabel screen2) {
        screen1 = screen2;
    }
    @Override
    public void actionPerformed(ActionEvent e) {
        String valueKeyPressed;
        if (Calculator_v8.operand1 != null && Calculator_v8.operand2 == null) {
            valueKeyPressed = ((JButton) e.getSource()).getText();
            if (valueKeyPressed.equalsIgnoreCase("exp")) {
                Calculator_v8.operator = "^";
                screen1.setText(Calculator_v8.operand1.toString()
                        .concat(Calculator_v8.operator));
            } else {
                if (valueKeyPressed.equalsIgnoreCase("\u00f7")) {
                    ...
                    if (valueKeyPressed.equalsIgnoreCase("\u00d7")) {
                        ...
                        Calculator_v8.operator = valueKeyPressed;
                        screen1.setText(Calculator_v8.operand1.toString()
                                .concat(Calculator_v8.operator));
                    }
                }
        ...
        if (Calculator_v8.operand1 != null && Calculator_v8.operand2 != null) {
            ...
            if (valueKeyPressed.equalsIgnoreCase("exp")) {
                Calculator_v8.operator = "^";
                screen1.setText(Calculator_v8.operand1 + "" 
                        + Calculator_v8.operator + Calculator_v8.operand2);
            } else {
                if (valueKeyPressed.equalsIgnoreCase("\u00f7")) {
                    Calculator_v8.operator = "/";
                    screen1.setText(Calculator_v8.operand1.toString()
                            .concat("\u00f7") + Calculator_v8.operand2);
                } else {
                    if (valueKeyPressed.equalsIgnoreCase("\u00d7")) {
                        Calculator_v8.operator = "*";
                        screen1.setText(Calculator_v8.operand1.toString()
 ...
 */
class DotButtonActionListener_v8 implements ActionListener {
    /*
     ...
     * DotButtonActionListener_v8 dobal = new DotButtonActionListener_v8(screen); 
     * when dobal an object of DotButtonActionListener_v8 is created, its screen1
     * reference is set to the Calculator screen
     */
    DotButtonActionListener_v8(JLabel screen2) {
        screen1 = screen2;
    }
    /*
                ...
                if (Calculator_v8.operand2 != null) {
                        ...
                        if (Calculator_v8.operator.equalsIgnoreCase("/")) {
                            ...
                            if (Calculator_v8.operator.equalsIgnoreCase("+")) {
                                ...
                                if (Calculator_v8.operator.equalsIgnoreCase("^")) {
                                    ...
                                    temp = (screen1.getText().
                                            split(Calculator_v8.operator))[1];
                                }
                            }
                        }
                    }
                    ...
                    if (temp.contains(valueKeyPressed) == false) {
                        if (temp.endsWith(".") == false) {
                            ...
                            valueKeyPressed = screen1.getText().
                                    concat(valueKeyPressed);
                            Calculator_v8.operand2 = Double.parseDouble(temp);
                            screen1.setText(valueKeyPressed);
                        }
                    }
                }
