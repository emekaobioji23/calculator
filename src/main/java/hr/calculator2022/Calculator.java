...
public class Calculator {
    ...
    public static boolean checkIfEndsInZero(Double operand) {
        boolean toreturn = false;
        String op_str = String.valueOf(operand);
        if (op_str.endsWith(".0")) {
            toreturn = true;
        }
        return toreturn;
    }
    public static String formatForDisplay(Double operand) {
        String operandAsString = String.valueOf(operand);
        if (checkIfEndsInZero(operand)) {
            operandAsString = operandAsString.substring(0, operandAsString.length()-2);
        }
    ...
    public static void main(String[] args) {
        ...
        //new code
        calculatorWindow.
                setIconImage(new ImageIcon(Calculator.class.
        ...
        GeneralKeyBoardActivityListener gkbal
                = new GeneralKeyBoardActivityListener(calculatorButtons);
        ...
        NormalButtonActionListener nbal
                = new NormalButtonActionListener(screen);
        ...
        DelButtonActionListener dbal
                = new DelButtonActionListener(screen/*
        ...
        ACButtonActionListener acbal
                = new ACButtonActionListener(screen);
        ...
        //new code
        OperatorButtonActionListener obal
                = new OperatorButtonActionListener(screen);
        ...
        EqualsButtonActionListener eqbal = new EqualsButtonActionListener(screen);
...
class DelButtonActionListener implements ActionListener {
     ...
     */
    DelButtonActionListener(JLabel screen2, /*new code*/ 
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (Calculator.operand2 != null) {
            ...
            if (op2string.length() > 1) {
                ...
                Calculator.operand2 = Double.parseDouble(op2string);
                /*
                ...
                screen1.setText(Calculator.formatForDisplay(Calculator.operand1) + op2disp + 
                        Calculator.operand2);
            } else {
            ...
            if (Calculator.operator != null) {
                ...
                screen1.setText(Calculator.formatForDisplay(Calculator.operand1));
            } else {
                if (Calculator.operand1 != null) {
                    ...
                    if (op1string.length() > 1) {
                        op1string = op1string.substring(0, 
                                op1string.length() - 1);
                        Calculator.operand1 = Double.parseDouble(op1string);
                        screen1.setText(Calculator.formatForDisplay(Calculator.operand1));
                    } else {
...
class EqualsButtonActionListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        //new code
        if(Calculator.operand1!=null&&
                Calculator.operator!=null&&Calculator.operand2!=null){
            if(Calculator.operator.equalsIgnoreCase("^")){
                Calculator.answer=Math.
                        pow(Calculator.operand1,Calculator.operand2);
            }
            if(Calculator.operator.equalsIgnoreCase("+")){
            ...
            if(Calculator.operator.equalsIgnoreCase("-")){
                ...
                Calculator.answer= Double.parseDouble(nf.
                        format(Calculator.operand1-Calculator.operand2));
            }
            if(Calculator.operator.equalsIgnoreCase("*")){
                Calculator.answer=Calculator.operand1*Calculator.operand2;
            }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (Calculator.operand1 != null && Calculator.operand2 != null) {
            ...
            if (valueKeyPressed.equalsIgnoreCase("exp")) {
                Calculator.operator = "^";
                screen1.setText(Calculator.formatForDisplay(Calculator.operand1) + "" 
                        + Calculator.operator + Calculator.formatForDisplay(Calculator.operand2));
            } else {
                if (valueKeyPressed.equalsIgnoreCase("\u00f7")) {
                    Calculator.operator = "/";
                    screen1.setText(Calculator.formatForDisplay(Calculator.operand1)
                            .concat("\u00f7") + Calculator.formatForDisplay(Calculator.operand2));
                } else {
                    if (valueKeyPressed.equalsIgnoreCase("\u00d7")) {
                        Calculator.operator = "*";
                        screen1.setText(Calculator.formatForDisplay(Calculator.operand1)
                        ...
                        screen1.setText(Calculator.formatForDisplay(Calculator.operand1)
                                .concat(Calculator.operator) + 
                                Calculator.formatForDisplay(Calculator.operand2));
                    }
                }
            }
        }
                ...
                if (Calculator.operand2 != null) {
                    ...
                    if (temp.contains(valueKeyPressed) == false) {
                        if (temp.endsWith(".") == false) {
                            ...
                            valueKeyPressed = screen1.getText().
                                    concat(valueKeyPressed);
                            Calculator.operand2 = Double.parseDouble(temp);
                            screen1.setText(valueKeyPressed);
                        }
                    }
                }
